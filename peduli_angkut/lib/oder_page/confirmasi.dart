...
class Konfimasi extends StatefulWidget {
  Konfimasi({Key? key}) : super(key: key);

  @override
  State<Konfimasi> createState() => _KonfimasiState();
}

class _KonfimasiState extends State<Konfimasi> {
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage("assets/icon_confirmation.gif"),
                    fit: BoxFit.contain),
                boxShadow: const [],
              ),
            ),
